...
obj1.update(1) # amount of time passed, dt = 1
...
obj1.update(1) # another second passes
print(obj1.position) # new position of the object after 2 second
print(obj1.velocity) # new velocity of the object after 2 second